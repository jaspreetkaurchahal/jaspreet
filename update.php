...
{	
	if(isset($_POST['searchID']))
	{
			...
			if(isset($_POST['btnupdate']))
		{
			...
			$sql2="update users set Ename='$name', Egender='$gender', Edob='$dob', Eaddress='$address', Ecity='$city', Eprovince='$province', Epostal='$postcode', Eemail='$email' , Ejoiningdate='$joindate', Eannualpay=$annualbasicpay where Eid='$id' ";
			//echo $sql2;
...
<tr>
<td colspan="2">
<h3 align="center">Update Employee Here</h3>
</td>
</tr>
<tr>
<td>
